...
final class ManagingShippingMethodContext implements Context
{
     ...
     */
    public function thePplParcelshopsShouldBeEnabled(): void
    {
     ...
     */
    public function iDisablePplParcelshops(): void
    {
     ...
     */
    public function thePplParcelshopsShouldBeDisabled(): void
    {
     ...
     */
    public function iSelectAllowedPplCountries(string $countryCodes): void
    {
     ...
     */
    public function iSelectDefaultPplCountry(string $countryCode): void
    {
     ...
     */
    public function theAllowedPplCountriesShouldBe(string $countryCodes): void
    {
     ...
     */
    public function theDefaultPplCountryShouldBe(string $countryCode): void
    {
     ...
     */
    public function iShouldSeeValidationErrorForDefaultCountry(): void
    {
